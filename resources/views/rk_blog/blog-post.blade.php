@extends('frontend.f_layouts.master')
		    ...
		    <div class="container">
			    ...
			    <div class="blog-post-body">
				    <figure class="blog-banner">
				        <a href="https://made4dev.com"><img class="img-fluid" src="{{asset('frontend/assets/images/blog/blog-post-banner.jpg')}}" alt="image"></a>
	    ...
	    <section class="promo-section theme-bg-light py-5 text-center">
		    <div class="container">
                ...
                <figure class="promo-figure">
			        <a href="https://made4dev.com" target="_blank"><img class="img-fluid" src="{{asset('frontend/assets/images/promo-banner.jpg')}}" alt="image"></a>
			    </figure>
		    </div><!--//container-->
