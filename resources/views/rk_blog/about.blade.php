    ...
    <div class="main-wrapper">
	    ...
	    <article class="about-section py-5">
		    <div class="container">
			    ...
			    <figure><img class="img-fluid" src="{{asset('rk_blog/assets/images/about-me.jpg')}}" alt="image"></figure>
			    ...
			    <figure><a href="https://made4dev.com"><img class="img-fluid" src="{{asset('rk_blog/assets/images/promo-banner.jpg')}}" alt="image"></a></figure>
		    </div>
